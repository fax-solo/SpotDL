...
interface PlaylistDao {
    ...
    @Query("SELECT * FROM playlist_tracks WHERE playlistId = :playlistId ORDER BY position ASC")
    fun getPlaylistTracksFlow(playlistId: String): Flow<List<PlaylistTrackEntity>>
    ...
    suspend fun removeTrackByKey(playlistId: String, trackId: String)
    ...
    suspend fun setTrackPosition(playlistId: String, trackId: String, position: Int)
    ...
    @Query("SELECT * FROM playlist_tracks WHERE playlistId = :playlistId ORDER BY position ASC")
    fun getPlaylistTracksForReorder(playlistId: String): Flow<List<PlaylistTrackEntity>>
}