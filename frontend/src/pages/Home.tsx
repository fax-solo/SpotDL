      ...
      <div className="px-5 pt-6 pb-36 safe-area-top animate-pageEnter max-w-5xl mx-auto">
        ...
        <div className="relative mb-8">
          ...
          <div
            ...
            className="w-full pl-11 pr-10 py-3 rounded-xl bg-white dark:bg-dark-surface border border-light-border/40 dark:border-dark-border/40 text-sm text-light-muted dark:text-dark-muted cursor-pointer hover:border-accent/30 hover:shadow-sm transition-all active:scale-[0.99]"
            role="button"
            tabIndex={0}
                ...
                <div className="space-y-1">
                  {recentlyPlayed.slice(0, 5).map((t, i) => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/50 dark:hover:bg-zinc-800/50 transition-all cursor-pointer text-left active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-accent"
                    >
